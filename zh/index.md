...
安全智算与应用（Sigma）小组依托山东大学网络空间安全学院（研究院）密码团队，由[李增鹏](https://faculty.sdu.edu.cn/lizengpeng/zh_CN/index.htm)副教授牵头建设。李增鹏现为博士生导师、硕士生导师，并担任山东省高等学校青年创新团队项目负责人。团队面向可信数据空间中的身份可信、数据安全流通与密态计算需求，开展实用密码协议（Real-World Cryptographic Protocol）研究，致力于为数据合规流通、隐私保护与安全计算提供理论基础、关键技术和原型系统。

## 研究方向

- **门限密码与多方计算：** 研究分布式密钥、门限签名、门限/多密钥全同态加密与安全聚合，重点提升多方计算协议的效率、鲁棒性和实用性。
- **同态加密与安全计算：** 围绕全同态加密、隐私信息检索和隐私推理开展算法、协议与系统研究，解决加密数据难以高效计算的问题。
- **认证授权与保密通信：** 研究口令认证、匿名凭证与令牌、密钥协商和网络安全协议，结合 OIDC、FIDO、OAuth、TLS 1.3、5G-AKA、eSIM 与端到端加密通信，开展安全加固、形式化分析和后量子迁移研究。

相关研究着力解决数据存储环境不可信、传输过程易遭篡改以及密文数据难以高效计算等问题，成果服务于大语言模型提示词隐私与推理、机密计算远程证明与可信 AI、凭证及敏感影像泄露预警、密钥钱包与智能体访问控制、5G-AKA/eSIM 隐私保护，以及 TLS、IPsec VPN、DNSSEC 等网络协议的安全分析与后量子迁移。

## 科研项目与合作

研究成果发表于 IEEE TDSC、IEEE TIFS、IEEE TSC、IEEE/ACM ToN、ACM CCS、NDSS、ESORICS、ACSAC、ICWS 等期刊和会议。李增鹏主持国家自然科学基金面上项目、山东省优秀青年基金、山东省自然科学基金面上项目、科技部重点研发计划子课题，以及 CCF-产研合作基金（华为胡杨林、腾讯犀牛鸟）等项目，入选青岛市源头创新计划和山东大学青年学者未来计划。

团队与国内外科研机构和企业保持长期合作，围绕隐私计算、可信身份、远程证明和保密通信等方向，承担华为谢尔德实验室、公安部第一研究所、比特大陆等单位的委托课题，并与公安部第一研究所、南湖实验室围绕警务与政务场景开展合作，推动隐私增强技术落地应用。

团队围绕可信数据空间牵头获得：2025年中国职工技能协会网安专项特等奖、新域新质润扬科技专项奖和青岛市商用密码创新应用优秀方案；2024 年山东省“数据要素×”大赛二等奖、最具创新技术奖，以及江西省“数据要素×”大赛一等奖。
