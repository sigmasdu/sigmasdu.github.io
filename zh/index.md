...
&emsp;&emsp; 安全智算与应用（即，Sigma）小组隶属于山东大学网络空间安全学院（研究院）密码团队,是山东省高等学校青年创新团队。针对可信数据空间下身份可靠和数据可用的需求，开展“Real-World Cryptographic Protocol”研究，围绕数据安全智算、认证授权与保密通信等领域，聚焦于全同态加密、门限密码与安全多方计算，包括：基于全同态加密开展隐私信息检索及隐私推理；基于门限密码学开展门限/多密钥全同态加密、门限签名等多方计算范式；认证授权与密钥协商开展认证通信安全加固与密码协议形式化分析等。着重解决存储数据的“不可信”、传输数据的“被篡改”、加密数据的“难计算”等问题，为数据流转、合规、安全计算等需求提供理论和技术支撑。

&emsp;&emsp; 相关工作发表在ACM CCS、NDSS、ESORICS、ACSAC、ICWS、IEEE TDSC、IEEE TSC、IEEE/ACM ToN等。主持国家自然科学基金面上、山东省自然科学基金面上、CCF-产研合作基金(华为胡杨林、腾讯犀牛鸟)和科技部重点研发计划子课题等，入选山东省高等学校青年创新团队项目负责人、青岛市源头创新计划和山东大学青年学者未来计划。同时，与国内（外）业界公司保持密切交流合作，与公安一所/南湖实验室开展警务/政务深入合作，承担华为谢尔德实验室、公安一所、比特大陆等横向委托课题，推动隐私增强技术落地应用。围绕可信数据空间领域，牵头获2025年度中国职工技能协会网安专项特等奖；2025年度新域新质润扬科技专项奖；2025年青岛市商用密码创新应用优秀方案；2024年度山东省数据要素X二等奖、最具创新技术奖；2024年度江西省数据要素大赛一等奖。

&emsp;&emsp; Sigma小组承担了《网络工程与防御实践 SD04630270》、《安全多方计算 SD04630460》、《网络安全法 SD04630150》和《计算机取证 SD04630470》等本科课程；《新技术安全 0740028》与《创新与思辨 0740037》（又名方滨兴院士班，山东省研究生教育优质课程）等研究生课程，以及《安全多方计算选讲 SQ0461049H》、《隐私增强计算选讲 SQ046104BN》和《应用密码与信息物理系统安全 SQ0461052H》等暑期学校海外师资课程。

&emsp;&emsp; Sigma小组与中国电科、中国电子、中国交通、通用技术研究院开展卓越工程师联合培养，指导学生获得2025年度中国网络空间安全协会优秀指导教师（1/16）。连续两年度获得山东大学本科毕业论文优秀指导教师。连续多年指导学生参加竞赛，累计获得中国密码学会密码技术竞赛一等奖1项、密码数据挑战赛二等奖1项，密码技术竞赛二等奖2项，密码科普竞赛二等奖2项，信息安全竞赛三等奖2项。连续5年组织隐私增强技术前沿讲习暑期学校，《安全多方计算选讲》获评优秀暑期课程，线上线下累计受益超千人。主笔撰写《网络工程与防御实践》教材1本，参与撰写科学出版社教材《现代密码学导论》和《密码学隐私增强技术导论》。

&emsp;&emsp; Sigma小组在青岛市委机要保密局支持下建设密码与保密技术实验室。在产学研用方面，拥有自主产权的安全多方计算仿真教学一体机，研发了分布式随机数生成机制与密钥管理系统，以及门限钱包系统，搭建了口令泄漏预警系统；在保密取证方面，拥有美亚柏科FL2000等先进的保密取证一体机；研发了Sigma-DBS（敏感数据泄密检查与取证系统）；并自建了Sigma-Range靶场并通过了CNAS认证，提供200多靶标的实训与教程。
